            ...
            <div id="legal-code-body" >
              ...
              <ol type="a">
                ...
                <li id="s1g_license_elements_sa">
                  ...
                  son los atributos que figuran en el nombre de la Licencia Pública de Creative Commons. Los Elementos de la Licencia de esta Licencia Pública son Atribución/Reconocimiento y CompartirIgual.
                </li>
                ...
                <li id="s1l_sui_generis_database_rights">
                  ...
                  <strong>
                    Derechos "Sui Generis" sobre Bases de Datos
                  </strong>
                ...
                <li id="s1m_you">
                  ...
                  es el individuo o la entidad que ejerce los Derechos Licenciados en esta Licencia Pública. La palabra
                  <strong>
                    Su
                  </strong>
                ...
                <li id="s2a">
                  ...
                  <ol>
                    ...
                    <li id="s2a3">
                      ...
                      . La vigencia de esta Licencia Pública está especificada en la sección
                      <a href="#s6a">
                        6(a)
                      </a>
                      .
                    ...
                    <li id="s2a5">
                      ...
                      <ol type="A">
                        <li id="s2a5A_offer">
                          <span >
                            Oferta del Licenciante – Material Licenciado
                          </span>
                          . Cada receptor de Material Licenciado recibe automáticamente una oferta del Licenciante para ejercer los Derechos Licenciados bajo los términos y condiciones de esta Licencia Pública.
                        </li>
                        <li id="s2a5B_adapted_material">
                          <span >
                            Oferta adicional por parte del Licenciante – Material Adaptado
                          </span>
                          . Cada receptor del Material Adaptado por Usted recibe automáticamente una oferta del Licenciante para ejercer los Derechos Licenciados en el Material Adaptado bajo las condiciones de la Licencia del Adaptador que Usted aplique.
                        </li>
                        <li id="s2a5C_no_restrictions">
                          <span >
                            Sin restricciones a receptores posteriores
                          </span>
                          . Usted no puede ofrecer o imponer ningún término ni condición diferente o adicional, ni puede aplicar ninguna Medida Tecnológica Efectiva al Material Licenciado si haciéndolo restringe el ejercicio de los Derechos Licenciados a cualquier receptor del Material Licenciado.
                        </li>
                      </ol>
                    </li>
                    <li id="s2a6">
                      ...
                      . Nada de lo contenido en esta Licencia Pública constituye o puede interpretarse como un permiso para afirmar o implicar que Usted, o que Su uso del Material Licenciado, está conectado, patrocinado, respaldado o reconocido con estatus oficial por el Licenciante u otros designados para recibir la Atribución/Reconocimiento según lo dispuesto en la sección
                      <a href="#s3a1Ai">
                        3(a)(1)(A)(i)
                      </a>
                      .
              ...
              <ol type="a">
                <li id="s3a">
                  ...
                  <ol type="1">
                    ...
                    <li id="s3a2">
                      Usted puede satisfacer las condiciones de la sección
                      <a href="#s3a1">
                        3(a)(1)
                      </a>
                      de cualquier forma razonable según el medio, las maneras y el contexto en los cuales Usted Comparta el Material Licenciado. Por ejemplo, puede ser razonable satisfacer las condiciones facilitando un URI o un hipervínculo a un recurso que incluya la información requerida.
                    </li>
                    <li id="s3a3">
                      Bajo requerimiento del Licenciante, Usted debe eliminar cualquier información requerida por la sección
                      <a href="#s3a1A">
                        3(a)(1)(A)
                      </a>
                ...
                <li id="s3b">
                  ...
                  .
                  <p>
                    Además de las condiciones de la sección
                    <a href="#s3a">
                      3(a)
                    </a>
                    , si Usted Comparte Material Adaptado producido por Usted, también aplican las condiciones siguientes.
                  </p>
                  <ol>
                    <li id="s3b1">
              ...
              <ol type="a">
                <li id="s4a">
                  para evitar cualquier duda, la sección
                  <a href="#s2a1">
                    2(a)(1)
                  </a>
                  le concede a Usted el derecho a extraer, reutilizar, reproducir y Compartir todo o una parte sustancial de los contenidos de la base de datos;
                </li>
                <li id="s4b">
                  si Usted incluye la totalidad o una parte sustancial del contenido de una base de datos en otra sobre la cual Usted ostenta Derecho "Sui Generis" sobre Bases de Datos, entonces ella (pero no sus contenidos individuales) se entenderá como Material Adaptado para efectos de la sección
                  <a href="#s3b">
                    3(b)
                  </a>
                  ; y
                ...
                <li id="s4c">
                  Usted debe cumplir con las condiciones de la sección
                  <a href="#s3a">
                    3(a)
                  </a>
                  si Usted Comparte la totalidad o una parte sustancial de los contenidos de la base de datos.
                </li>
              </ol>
              <p>
                ...
                complementa y no sustituye Sus obligaciones bajo esta Licencia Pública cuando los Derechos Licenciados incluyen otros Derechos de Autor y Derechos Similares.
              </p>
